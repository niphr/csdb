...
`DBConnection_v9` wraps an ODBC or SQLite connection with lazy connect,
explicit disconnect, and automatic reconnect via `$autoconnection`.
...
PostgreSQL, SQL Server and SQLite tables, with configurable indexes.
